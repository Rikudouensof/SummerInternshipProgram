...
namespace SummerInternshipProgram.API.Controllers
{
    ...
    public class DropdownQuestionController : ControllerBase
    {
        ...
        private string classname = nameof(DropdownQuestionController);
        private IDropdownQuestionService _dbService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public DropdownQuestionController(ILogHelper logger, IDropdownQuestionService db, IWebHostEnvironment webHostEnvironment)
        {
            _dbService = db;
            _logger = logger;
        ...
        [HttpPost("Add")]
        public async Task<IActionResult> AddSingle([FromBody] DropdownQuestion input, [FromHeader] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Add(new BaseRequestDto<DropdownQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> UpdateSingle([FromBody] DropdownQuestion input, [FromForm] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Update(new BaseRequestDto<DropdownQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
