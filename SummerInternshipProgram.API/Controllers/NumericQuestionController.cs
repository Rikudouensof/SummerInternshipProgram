...
namespace SummerInternshipProgram.API.Controllers
{
    ...
    [ApiController]
    public class NumericQuestionController : ControllerBase
    {
        private readonly ILogHelper _logger;
        private string classname = nameof(NumericQuestionController);
        private INumericQuestionService _dbService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public NumericQuestionController(ILogHelper logger, INumericQuestionService db, IWebHostEnvironment webHostEnvironment)
        {
            _dbService = db;
            _logger = logger;
        ...
        [HttpPost("Add")]
        public async Task<IActionResult> AddSingle([FromBody] NumericQuestion input, [FromHeader] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Add(new BaseRequestDto<NumericQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> UpdateSingle([FromBody] NumericQuestion input, [FromForm] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Update(new BaseRequestDto<NumericQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
