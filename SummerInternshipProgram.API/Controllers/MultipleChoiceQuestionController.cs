...
namespace SummerInternshipProgram.API.Controllers
{
    ...
    public class MultipleChoiceQuestionController : ControllerBase
    {
        ...
        private string classname = nameof(MultipleChoiceQuestionController);
        private IMultipleChoiceQuestionService _dbService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public MultipleChoiceQuestionController(ILogHelper logger, IMultipleChoiceQuestionService db, IWebHostEnvironment webHostEnvironment)
        {
            _dbService = db;
            _logger = logger;
        ...
        [HttpPost("Add")]
        public async Task<IActionResult> AddSingle([FromBody] MultipleChoiceQuestion input, [FromHeader] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Add(new BaseRequestDto<MultipleChoiceQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> UpdateSingle([FromBody] MultipleChoiceQuestion input, [FromForm] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Update(new BaseRequestDto<MultipleChoiceQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
