...
namespace SummerInternshipProgram.API.Controllers
{
    ...
    public class ParagraphQuestionController : ControllerBase
    {
        ...
        private string classname = nameof(ParagraphQuestionController);
        private IParagraphQuestionService _dbService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public ParagraphQuestionController(ILogHelper logger, IParagraphQuestionService db, IWebHostEnvironment webHostEnvironment)
        {
            _dbService = db;
            _logger = logger;
        ...
        [HttpPost("Add")]
        public async Task<IActionResult> AddSingle([FromBody] ParagraphQuestion input, [FromHeader] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Add(new BaseRequestDto<ParagraphQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> UpdateSingle([FromBody] ParagraphQuestion input, [FromForm] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Update(new BaseRequestDto<ParagraphQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
