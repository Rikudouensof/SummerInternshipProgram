...
namespace SummerInternshipProgram.API.Controllers
{
    ...
    [ApiController]
    public class GenderServiceController : ControllerBase
    {

        private readonly ILogHelper _logger;
        private string classname = nameof(GenderServiceController);
        private IGenderService _dbService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public GenderServiceController(ILogHelper logger, IGenderService db, IWebHostEnvironment webHostEnvironment)
        {
            _dbService = db;
            _logger = logger;
        ...
        [HttpPost("Add")]
        public async Task<IActionResult> AddSingle([FromBody] Gender input, [FromHeader] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Add(new BaseRequestDto<Gender>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> UpdateSingle([FromBody] Gender input, [FromForm] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Update(new BaseRequestDto<Gender>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
