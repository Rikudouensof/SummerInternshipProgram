...
namespace SummerInternshipProgram.API.Controllers
{
    ...
    public class InternshipProgramController : ControllerBase
    {
        ...
        private string classname = nameof(InternshipProgramController);
        private IInternshipProgramService _dbService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public InternshipProgramController(ILogHelper logger, IInternshipProgramService db, IWebHostEnvironment webHostEnvironment)
        {
            _dbService = db;
            _logger = logger;
        ...
        [HttpPost("Add")]
        public async Task<IActionResult> AddSingle([FromBody] InternshipProgram input)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Add(new BaseRequestDto<InternshipProgram>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> UpdateSingle([FromBody] InternshipProgram input)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Update(new BaseRequestDto<InternshipProgram>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
