...
namespace SummerInternshipProgram.API.Controllers
{
    ...
    public class DateQuestionController : ControllerBase
    {
        ...
        private string classname = nameof(DateQuestionController);
        private IDateQuestionService _dbService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public DateQuestionController(ILogHelper logger, IDateQuestionService db, IWebHostEnvironment webHostEnvironment)
        {
            _dbService = db;
            _logger = logger;
        ...
        [HttpPost("Add")]
        public async Task<IActionResult> AddSingle([FromBody] DateQuestion input, [FromHeader] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Add(new BaseRequestDto<DateQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> UpdateSingle([FromBody] DateQuestion input, [FromForm] string? applicantId)
        {
            ...
            try
            {
                var dbResponse = await _dbService.Update(new BaseRequestDto<DateQuestion>()
                {
                    Ip = Ip,
                    Request = input,
                    RequestId = requestId
